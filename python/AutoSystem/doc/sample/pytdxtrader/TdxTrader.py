...
class TdxTrader:
    ...
    config['xnzq'] = { \
        'lOrderColumn': [{'text': '委托时间', 'key': 'time'}, {'text': '证券代码', 'key': 'symbol'}, \
                         {'text': '证券名称', 'key': 'name'}, {'text': '买卖标志', 'key': 'direction'},
                         {'text': '委托类别', 'key': 'order_type'} \
            , {'text': '状态说明', 'key': 'status'}, {'text': '委托价格', 'key': 'price'}, {'text': '委托数量', 'key': 'volume'} \
            , {'text': '委托编号', 'key': 'exchange_order_id'}, {'text': '成交价格', 'key': 'traded_price'},
                         {'text': '成交数量', 'key': 'volume_traded'} \
            , {'text': '报价方式', 'key': 'price_type'}, {'text': '股东代码', 'key': 'account_id'},
                         {'text': '废单原因', 'key': 'error_info'}] \
        , \
        'lTradeColumn': [{'text': '成交时间', 'key': 'time'}, {'text': '证券代码', 'key': 'symbol'} \
            ...
            , {'text': '委托编号', 'key': 'exchange_order_id'}, {'text': '股东代码', 'key': 'account_id'},
                         {'text': '成交类型', 'key': 'trade_type'}] \
        , \
        'title_re': '西南' \
        , 'order_status_str': {'done': '已成交', 'canceled': '已撤单已撤', 'pending': '已申报'} \
        }
    ...
    config['axzq'] = { \
        'lOrderColumn': [{'text': '委托时间', 'key': 'time'}, {'text': '委托编号', 'key': 'exchange_order_id'} \
            ...
            , {'text': '委托类型', 'key': 'order_type'}, {'text': '委托价格', 'key': 'price'},
                         {'text': '委托数量', 'key': 'volume'}, {'text': '委托金额', 'key': 'amount'} \
            , {'text': '成交价格', 'key': 'traded_price'}, {'text': '成交数量', 'key': 'volume_traded'},
                         {'text': '成交金额', 'key': 'traded_amount'} \
            , {'text': '已撤数量', 'key': 'volume_canceled'}, {'text': '撤单标志', 'key': 'status'},
                         {'text': '股东代码', 'key': 'account_id'} \
            , {'text': '市场', 'key': 'exchange'}, {'text': '客户代码', 'key': 'investorid'},
                         {'text': '资金帐号', 'key': 'account_id'} \
            , {'text': '股东姓名', 'key': 'account_name'}, {'text': '合法标志', 'key': 'legal_flag'},
                         {'text': '摘要', 'key': 'comment'} \
                         ], \
        'lTradeColumn': [{'text': '委托时间', 'key': 'time'}, {'text': '委托编号', 'key': 'exchange_order_id'},
                         {'text': '证券代码', 'key': 'symbol'} \
            , {'text': '证券名称', 'key': 'name'}, {'text': '买卖标志', 'key': 'direction'},
                         {'text': '委托类型', 'key': 'order_type'} \
            , {'text': '委托价格', 'key': 'order_price'}, {'text': '委托数量', 'key': 'order_volume'},
                         {'text': '成交价格', 'key': 'price'} \
            , {'text': '成交数量', 'key': 'volume'}, {'text': '成交金额', 'key': 'amount'}, {'text': '成交时间', 'key': 'time'} \
            , {'text': '股东代码', 'key': 'holder_id'}, {'text': '资金帐号', 'key': 'account_id'},
                         {'text': '客户代码', 'key': 'investorid'} \
            , {'text': '股东姓名', 'key': 'account_name'}, {'text': '市场', 'key': 'exchange'},
                         {'text': '成交编号', 'key': 'trade_id'} \
                         ], \
        'title_re': '安信' \
        , 'order_status_str': {'done': '已成交', 'canceled': '已撤单已撤', 'pending': '已申报'} \
    ...
    config['dycy'] = { \
        'lOrderColumn': [{'text': '委托日期', 'key': 'date'}, {'text': '委托时间', 'key': 'time'},
                         {'text': '证券代码', 'key': 'symbol'} \
            , {'text': '证券名称', 'key': 'name'}, {'text': '买卖标志', 'key': 'direction'}, {'text': '委托价格', 'key': 'price'} \
            , {'text': '委托数量', 'key': 'volume'}, {'text': '委托编号', 'key': 'exchange_order_id'},
                         {'text': '成交数量', 'key': 'volume_traded'} \
            , {'text': '撤单数量', 'key': 'volume_canceled'}, {'text': '状态说明', 'key': 'status1'},
                         {'text': '撤单标志', 'key': 'status'} \
            , {'text': '股东代码', 'key': 'account_id'}, {'text': '操作日期', 'key': 'op_date'},
                         {'text': '信息说明', 'key': 'content'} \
                         ], \
        'lTradeColumn': [{'text': '成交日期', 'key': 'date'}, {'text': '成交时间', 'key': 'time'},
                         {'text': '证券代码', 'key': 'symbol'} \
            , {'text': '证券名称', 'key': 'name'}, {'text': '买卖标志', 'key': 'direction'}, {'text': '委托价格', 'key': 'price'},
                         {'text': '委托数量', 'key': 'order_volume'} \
            , {'text': '委托编号', 'key': 'exchange_order_id'}, {'text': '成交价格', 'key': 'price'},
                         {'text': '成交数量', 'key': 'volume_traded'} \
            , {'text': '成交金额', 'key': 'amount'}, {'text': '成交编号', 'key': 'trade_id'},
                         {'text': '股东代码', 'key': 'holder_id'}, {'text': '状态说明', 'key': 'status'}
    ...
    def gethandle(self):
        ...
        hRightHeader = win32gui.GetDlgItem(hRightHeader, 0);
        print('hRightHeader:%x' % hRightHeader)
    ...
    def update_order(self):
        ...
        for i in range(1, 10):
            ...
            if pywinauto.controls.win32_controls.ButtonWrapper(self.hOrderRefresh).IsVisible() == False:
                ...
                pywinauto.controls.common_controls.TreeViewWrapper(self.hTreeLeft).EnsureVisible(path)
                rect = pywinauto.controls.common_controls.TreeViewWrapper(self.hTreeLeft).GetItem(path).Rectangle()
                pywinauto.controls.HwndWrapper.HwndWrapper(self.hTreeLeft).ClickInput(
                    coords=(rect.left + 5, rect.top + 5))
                print('click order')
                tm.sleep(0.2)
            else:
                break
        ...
        if len(t) > 0 and (len(t) - 1) % cc == 0:
            for i in range(1, len(t)):
                ...
                if len(ret) <= r:
                    ret.append({'comment': ''})
                ret[r][self.lOrderColumn[c]['key']] = t[
                    i];  # print('r%d, key:%s, value:%s'%(r,self.lOrderColumn[c]['key'],t[i]))
    ...
    def buy(self, symbol, direction, price, volume):
        ...
        for i in range(1, 15):
            try:
                hResult = pywinauto.findwindows.find_window(class_name='#32770', title_re='交易确认',
                ...
                if len(t) >= 4:
                    if t[0].count('买入') == 0 or t[1].count(symbol) == 0 or t[2].count(str(price)) == 0 or t[3].count(
                            str(volume)) == 0:
    ...
    def sell(self, symbol, direction, price, volume):
        ...
        for i in range(1, 15):
            try:
                ...
                t = pywinauto.controls.HwndWrapper.HwndWrapper(hResultText).WindowText().splitlines()
                if len(t) >= 4:
                    if t[0].count('卖出') == 0 or t[1].count(symbol) == 0 or t[2].count(str(price)) == 0 or t[3].count(
                            str(volume)) == 0:
                        return {'exchange_order_id': '', 'error_info': '交易确认参数错误'}
                pywinauto.controls.HwndWrapper.HwndWrapper(hResultConfirm).Click()
                break
        ...
        if len(t) > 0 and (len(t) - 1) % cc == 0:
            for i in range(1, len(t)):
                ...
                if self.lOrderColumn[c]['key'] == "exchange_order_id" and t[i] == exchange_order_id:
                    ...
                    for i in range(1, 15):
                        try:
                            hResult = pywinauto.findwindows.find_window(class_name='#32770', title_re='提示',
                                                                        process=self.processId)
                            hResultText = win32gui.GetDlgItem(hResult, 0x1B65)
                            hResultConfirm = win32gui.GetDlgItem(hResult, 0x1B67)
                            t = pywinauto.controls.HwndWrapper.HwndWrapper(hResultText).WindowText().splitlines()
