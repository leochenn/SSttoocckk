...
public class StockDetailBiz {
    ...
    public String getString(SinaStockBean data) {
        ...
        float a = FloatUtil.handleFloat(data.todayCurrentPrice * 1.0025f); // 涨0.25% 0.0025
        float b = FloatUtil.handleFloat(data.todayCurrentPrice * 1.005f);  // 涨0.5% 0.005
        float c = FloatUtil.handleFloat(data.todayCurrentPrice * 1.0075f); // 涨0.75% 0.0075
        float d = FloatUtil.handleFloat(data.todayCurrentPrice * 1.01f);  // 涨1% 0.01
        ...
        float a1 = FloatUtil.handleFloat(data.todayCurrentPrice * 0.9975f); // 跌0.25% 0.0025
        float b1 = FloatUtil.handleFloat(data.todayCurrentPrice * 0.995f);  // 跌0.5% 0.005
        float c1 = FloatUtil.handleFloat(data.todayCurrentPrice * 0.9925f); // 跌0.75% 0.0075
        float d1 = FloatUtil.handleFloat(data.todayCurrentPrice * 0.99f);  // 跌1% 0.01
